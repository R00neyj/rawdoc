...
import { wikiTitlesField } from './preview/wikiLinks.js'
import { wikiCompletionSource } from './wikiComplete.js'

function makeState(doc, { anchor, titles = ['사용법'] } = {}) {
