...
/**
 * @param {object} deps
 * @param {() => Promise<void>} deps.beforeReload 새 버전 적용 전 대기 중 저장을 끝낸다
 * @returns {{ updateAvailable: boolean, applyUpdate: () => Promise<void> }}
 */
export function useAppUpdate({ beforeReload }) {
