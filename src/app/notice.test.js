...
describe('pushNotice', () => {
  ...
  it('info 는 새 warn 으로 대체된다', () => {
    const next = { type: 'warn', message: 'warn' }
    expect(pushNotice({ type: 'info', message: 'old' }, next)).toBe(next)
  })
})
