// 공유받은 문서 화면 S-4 (specs/ia.md 1장 S-4·3.19, specs/features/F-130.md 4장)
// 위키링크(F-131)는 여기서 만들지 않는다 — Viewer 에 문서 목록을 넘기지 않으면
...
/**
 * @param {object} props
 * @param {{title:string, content:string, lineEnding:'crlf'|'lf'}} props.sharedDoc decodeShare 결과
 * @param {() => void} props.onImport `내 문서로 가져오기`
 * @param {() => void} props.onClose `닫기`
 */
export default function SharedView({ sharedDoc, onImport, onClose }) {
